...
# Blog 2-SAM – Giúp mình deploy AWS mà không phải click chuột
...
Ai muốn đọc chi tiết thì xem tại đây: https://docs.aws.amazon.com/serverless-application-model/
...
Viết template.yaml để khai báo toàn bộ hạ tầng: Lambda, S3, DynamoDB, SQS, EventBridge…
sam build để SAM chuyển template thành CloudFormation.
sam deploy để deploy lên AWS, đồng thời tạo Change Set giúp review những gì sắp thay đổi trước khi apply.
SAM Workflow
