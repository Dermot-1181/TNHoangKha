...
# Blog 2 - SAM – Deploy AWS Without Clicking
...
For the full details: https://docs.aws.amazon.com/serverless-application-model/
...
Write template.yaml to declare the entire infrastructure: Lambda, S3, DynamoDB, SQS, EventBridge…
sam build — SAM transforms the template into CloudFormation.
sam deploy — deploy to AWS, with a Change Set to review what will change before applying.
SAM Workflow
