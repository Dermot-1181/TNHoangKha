...
# Blog 3 - Automating PostgreSQL Audit Log Extraction and Analysis with Amazon S3
...
PostgreSQL generates audit logs via pgAudit
CloudWatch Logs receives logs and uses a subscription filter to detect lines containing the “AUDIT” keyword
Triggers AWS Lambda for processing
Lambda parses raw text into structured CSV with all fields: timestamp, user, database, action, object_type, object_name, query
Saves to Amazon S3 with year/month/day partitioning
Optionally uses Amazon Athena to query directly with SQL
...
Reference: [https://aws.amazon.com/blogs/database/automate-postgresql-audit-log-extraction-and-analysis-with-amazon-s3/](https://aws.amazon.com/blogs/database/automate-postgresql-audit-log-extraction-and-analysis-with-amazon-s3/)
