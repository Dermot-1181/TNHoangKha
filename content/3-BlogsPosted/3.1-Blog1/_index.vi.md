...
Tải về từ [kiro.dev](http://kiro.dev), tạo 1 folder `.kiro/steering/` bỏ vài file markdown luật chơi vô, tạo folder `.kiro/hooks/` bỏ vài file JSON trigger vô, xong. 10 phút là chạy được.
